                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 entries">
                        ...
                        <article class="entry">
                            ...
                            $blog_select = "SELECT * FROM blog where id='1'";
                            $blog_query = mysqli_query($con, $blog_select);
                            $blog_result = mysqli_fetch_array($blog_query);
                            ?>

                            <div class="entry-img">
                                <img src="admin/update/<?php echo $blog_result['blog_photo'] ?>" class=" img-fluid" alt="" style="width: 100%; height: 700px; object-fit:cover ; object-position: 15% 50%; ; ">
                            </div>
                            ...
                            <div class="entry-meta">
                                <ul>
                                    <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-single.html"><?php echo $blog_result['blog_by']?></a></li>
                                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-single.html"><time datetime="<?php echo $blog_result['blog_time']?>"><?php echo $blog_result['blog_time']?></time></a></li>
                                </ul>
                            </div>
